...
public class QuickSortPooled {
	...
	public void quickSort(final int[] data) {
		pool = new ThreadPoolExecutor(0, 20, 10L, TimeUnit.MILLISECONDS,
	...
	private void quickSortWorker(final int[] data, final int left,
	        final int right, final Thread toInterrupt) {
	}
}
