...
public interface Grid {
	 ...
	 * @param x x-coordinate of the specific cell
	 * @param y y-coordinate of the specific cell
	 * @return current state of the cell which is true for living or false for dead 
	 */
	 ...
	 * @param start upper left point of the specific rectangular region
	 * @param end lower right point of the specific rectangular region
	 */
